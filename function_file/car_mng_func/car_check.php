<<?php 
    ...
    $sql = "SELECT * FROM carTBL ORDER BY car_Available";
    ...
    echo "<body>";
    echo "<h1>[등록차량 정보]</h1>";
    echo "<A href='car_add.php' style='margin-left: 85%; text-decoration: none;'>[차량추가]</a>";
    ...
    while($row = mysqli_fetch_array($ret)) {
       ...
       if($row['car_Available'] == 1){
        echo "<TD>", "<A style='text-decoration: none; color: red;' HREF='car_disavail.php?car_Num=", $row['car_Num'], "'>[비활성화]</A></TD>";
       }
       if($row['car_Available'] == 0){
        echo "<TD>", "<p style='text-decoration: none; color: green'>[대여중]</p></TD>";
       }
       if($row['car_Available'] == -1){
         echo "<TD>", "<A style='text-decoration: none; color: blue' HREF='car_avail.php?car_Num=", $row['car_Num'], "'>[활성화]</A></TD>";
        }
       echo "</TR>";
    } 
    echo "</table>";
