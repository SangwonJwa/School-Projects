...
<body>
    ...
    <div class="home-content wrapper" id = "body-main">
        ...
        <button class="tablinks" onclick="openCity(event, 'London')">1. 차량 조회, 추가</button>
        <button class="tablinks" onclick="openCity(event, 'Paris')">2. 차량 정보 변경</button>
        <button class="tablinks" onclick="openCity(event, 'Tokyo')">3. 차량 삭제</button>
        </div>
        ...
        <div id="London" class="tabcontent">
            <iframe class="tabinside" src="../function_file/car_mng_func/car_check.php"></iframe>
        </div>

        <div id="Paris" class="tabcontent">
            <iframe class="tabinside" src="../function_file/car_mng_func/car_update.php"></iframe>
        </div>

        <div id="Tokyo" class="tabcontent">
            <iframe class="tabinside" src="../function_file/car_mng_func/car_delete.php"></iframe>
        </div>
