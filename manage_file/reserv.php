...
<body>
    ...
    <div class="home-content wrapper" id = "body-main">
        ...
        <button class="tablinks" onclick="openCity(event, 'London')">1. 나의 예약 내역</button>
        <button class="tablinks" onclick="openCity(event, 'Paris')">2. 예약 신청</button>
        </div>
        ...
        <div id="London" class="tabcontent">
            <iframe class="tabinside" src="../function_file/client_func/myrent.php"></iframe>
        </div>

        <div id="Paris" class="tabcontent">
            <iframe class="tabinside" src="../function_file/client_func/do_rent.php"></iframe>
        </div>
