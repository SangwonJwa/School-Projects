...
<body>
    ...
    <div class="home-content wrapper" id = "body-main">
        ...
        <button class="tablinks" onclick="openCity(event, 'London')">1. 내 정보 조회</button>
        <button class="tablinks" onclick="openCity(event, 'Paris')">2. 내 정보 변경</button>
        ...
        <div id="London" class="tabcontent">
            <iframe class="tabinside" src="../function_file/client_func/myinfo_check.php"></iframe>
        </div>

        <div id="Paris" class="tabcontent">
            <iframe class="tabinside" src="../function_file/client_func/info_update.php"></iframe>
        </div>
